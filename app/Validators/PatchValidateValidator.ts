...
export default class PatchValidateValidator {
  ...
  public schema = schema.create({
    employeeName: schema.string.optional({ trim: true }, [
    ...
    dob: schema.date.optional({ format: 'yyyy-MM-dd' }, [rules.before(18, 'years')]),
  ...
  public messages = {
    ...
    'date.format': '{{ field }} must be formatted as {{ YYYY-MM-DD }}',
